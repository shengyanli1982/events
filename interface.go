...
type MessageHandleFunc func(msg interface{}) (interface{}, error)
...
type PipelineInterface interface {
	...
	SubmitWithFunc(fn MessageHandleFunc, msg interface{}) error
	...
	SubmitAfterWithFunc(fn MessageHandleFunc, msg interface{}, delay time.Duration) error
